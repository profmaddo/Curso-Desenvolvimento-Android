package foo.maddo.poointerface.bonuspoo.view;
...
import foo.maddo.poointerface.R;
import foo.maddo.poointerface.bonuspoo.model.Carro;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chkPartida.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                objCarro.setNomeFabricante(editFabricante.getText().toString());
                objCarro.setGarantia("5 anos");
                objCarro.setPaisOrigem("Itália");
    ...
    public void fabricarCarro(){
        ...
        builder.setMessage("Fabricante: "+objCarro.getNomeFabricante()+"\nModelo: "+objCarro.getModelo()+"\nAno: "+objCarro.getAno()+"\nCor: "+objCarro.getCor())
